...
$(document).ready(function() {
    ...
    $('#example').DataTable({
          ...
          ajax: '{!! action("ProductoController@datatables") !!}',
          columns: [
                { data: 'nombre', name: 'nombre','orderable': true, 'searchable': true},
                { data: 'nro_serie', name: 'nro_serie','orderable': true, 'searchable': true},
                { data: 'id_patrimonial', name: 'id_patrimonial','orderable': true, 'searchable': true},
