...
class Producto extends Model {
	...
	public function scopeDatatables($query,$id) {
		return $query->where(array('subcuenta_id' => $id ));
	}
	...
	public function scopeCargode($query,$id,$tipodestino) {
		return $query->where(array('tip_destino' => $tipodestino , 'cod_destino' => $id));
	}
